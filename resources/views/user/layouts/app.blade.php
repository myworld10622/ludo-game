...
<div class="shell" id="userPanelShell">
    ...
    <aside class="sidebar">
        ...
        <a class="nav-link {{ request()->routeIs('panel.index') ? 'active' : '' }}" href="{{ route('panel.index') }}">Dashboard</a>
        @if (!empty($panelPermissions['manage_tournaments']))
            <a class="nav-link {{ request()->routeIs('panel.tournaments.*') ? 'active' : '' }}" href="{{ route('panel.tournaments.index') }}">Tournaments</a>
        @endif
        @if (!empty($panelPermissions['view_match_monitor']))
            <a class="nav-link {{ request()->routeIs('panel.matches.*') ? 'active' : '' }}" href="{{ route('panel.matches.index') }}">Match Monitor</a>
        @endif
        <a class="nav-link {{ request()->routeIs('panel.support.*') ? 'active' : '' }}" href="{{ route('panel.support.index') }}">Support Chat</a>
    </aside>
    <main class="content">
        <div class="topbar">
            <div class="topbar-main">
                ...
                <div>
                    <div style="font-size:24px;font-weight:700;">@yield('heading', 'User Panel')</div>
                    <div class="muted">@yield('subheading', 'Manage only your own tournaments and matches')</div>
                </div>
            </div>
