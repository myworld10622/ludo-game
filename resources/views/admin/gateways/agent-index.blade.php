...
@section('title', 'Agent Gateways')
@section('heading', 'Agent Gateways')
@section('subheading', 'Assign gateway numbers for agent deposits')
...
<div class="panel stack">
    ...
    <div class="panel">
        <div class="header-row">
            ...
            <a class="btn" href="{{ route('admin.gateways.agent.create') }}">Add Agent Gateway</a>
        </div>
                ...
                @forelse ($rows as $row)
                    ...
                    <tr>
                        ...
                        <td data-label="Action">
                            <a class="btn btn-secondary" href="{{ route('admin.gateways.agent.edit', $row->id) }}">Edit</a>
                        </td>
                    </tr>
                @empty
