...
<head>
    ...
    <title>@yield('title', 'Admin Panel') — RoxLudo</title>
...
<div class="admin-shell" id="adminPanelShell">
    ...
    <aside class="sidebar">
        ...
        <a class="nav-link {{ request()->routeIs('admin.games.index') ? 'active' : '' }}" href="{{ route('admin.games.index') }}">
            <span class="ni">🎮</span> Games
        </a>
        <a class="nav-link sub {{ request()->routeIs('admin.games.ludo-tables.*') ? 'active' : '' }}" href="{{ route('admin.games.ludo-tables.index') }}">↳ Classic Ludo Tables</a>

        <div class="nav-section">Tournaments</div>
        <a class="nav-link {{ request()->routeIs('admin.tournaments.index') || request()->routeIs('admin.tournaments.create') ? 'active' : '' }}" href="{{ route('admin.tournaments.index') }}">
            <span class="ni">🏆</span> Tournaments
        </a>
        <a class="nav-link sub {{ request()->routeIs('admin.tournaments.matches') ? 'active' : '' }}" href="{{ route('admin.tournaments.matches') }}">↳ Match Monitor</a>
        ...
        <a class="nav-link {{ request()->routeIs('admin.gateways.agent.*') ? 'active' : '' }}" href="{{ route('admin.gateways.agent.index') }}">
            <span class="ni">🔌</span> Agent Gateways
        </a>
        <a class="nav-link sub {{ request()->routeIs('admin.gateways.agent-withdraw.*') ? 'active' : '' }}" href="{{ route('admin.gateways.agent-withdraw.index') }}">↳ Agent Withdraw</a>
        <a class="nav-link {{ request()->routeIs('admin.gateways.distributor.*') ? 'active' : '' }}" href="{{ route('admin.gateways.distributor.index') }}">
            <span class="ni">🔌</span> Distributor Gateways
        </a>
        <a class="nav-link sub {{ request()->routeIs('admin.gateways.distributor-withdraw.*') ? 'active' : '' }}" href="{{ route('admin.gateways.distributor-withdraw.index') }}">↳ Distributor Withdraw</a>
        ...
        <a class="nav-link sub {{ request()->routeIs('admin.agents.create') ? 'active' : '' }}" href="{{ route('admin.agents.create') }}">↳ Add Agent</a>
        ...
        <a class="nav-link sub {{ request()->routeIs('admin.distributors.create') ? 'active' : '' }}" href="{{ route('admin.distributors.create') }}">↳ Add Distributor</a>

        <div class="nav-section">Reports & Config</div>
        <a class="nav-link {{ request()->routeIs('admin.legacy-reports.*') ? 'active' : '' }}" href="{{ route('admin.legacy-reports.index') }}">
            <span class="ni">📊</span> Legacy Reports
        </a>
        <a class="nav-link sub {{ request()->routeIs('admin.legacy-reports.purchase-history') ? 'active' : '' }}" href="{{ route('admin.legacy-reports.purchase-history') }}">↳ Purchase History</a>
        <a class="nav-link sub {{ request()->routeIs('admin.legacy-reports.deposit-bonus') ? 'active' : '' }}" href="{{ route('admin.legacy-reports.deposit-bonus') }}">↳ Deposit Bonus</a>
        <a class="nav-link sub {{ request()->routeIs('admin.legacy-reports.bet-commission') ? 'active' : '' }}" href="{{ route('admin.legacy-reports.bet-commission') }}">↳ Bet Commission</a>
        <a class="nav-link sub {{ request()->routeIs('admin.legacy-reports.rebate-history') ? 'active' : '' }}" href="{{ route('admin.legacy-reports.rebate-history') }}">↳ Rebate History</a>
        <a class="nav-link sub {{ request()->routeIs('admin.legacy-reports.welcome-bonus') ? 'active' : '' }}" href="{{ route('admin.legacy-reports.welcome-bonus') }}">↳ Welcome Bonus</a>
        <a class="nav-link sub {{ request()->routeIs('admin.legacy-reports.withdrawal-logs') ? 'active' : '' }}" href="{{ route('admin.legacy-reports.withdrawal-logs') }}">↳ Withdrawal Logs</a>
        <a class="nav-link sub {{ request()->routeIs('admin.legacy-reports.redeem-list') ? 'active' : '' }}" href="{{ route('admin.legacy-reports.redeem-list') }}">↳ Redeem List</a>
        <a class="nav-link {{ request()->routeIs('admin.audit-logs.*') ? 'active' : '' }}" href="{{ route('admin.audit-logs.index') }}">
            <span class="ni">🔍</span> Audit Logs
        </a>
        <a class="nav-link {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}" href="{{ route('admin.settings.app') }}">
            <span class="ni">⚙️</span> Settings
        </a>
        <a class="nav-link {{ request()->routeIs('admin.homepage-cards.*') ? 'active' : '' }}" href="{{ route('admin.homepage-cards.index') }}">
    ...
    <main class="content">
        <div class="topbar">
            <div class="topbar-main">
                ...
                <div>
                    <div class="topbar-heading">@yield('heading', 'Admin')</div>
                    <div class="topbar-sub">@yield('subheading', 'Operational control panel')</div>
                </div>
            </div>
