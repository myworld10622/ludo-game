            ...
            <div style="display:grid;gap:10px;">
                <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $enabled): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="display:flex;justify-content:space-between;align-items:center;padding:10px 12px;border:1px solid var(--line);border-radius:12px;background:#fffdfa;">
                        <span style="font-weight:600;"><?php echo e(ucwords(str_replace('_', ' ', $key))); ?></span>
                        <span class="badge" style="<?php echo e($enabled ? '' : 'background:#fee4e2;color:#b42318;border-color:#fecdca;'); ?>"><?php echo e($enabled ? 'Enabled' : 'Hidden'); ?></span>
                    </div>
...
<?php echo $__env->make('user.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Live-Code\games\backend_laravel\resources\views/user/panel/index.blade.php ENDPATH**/ ?>