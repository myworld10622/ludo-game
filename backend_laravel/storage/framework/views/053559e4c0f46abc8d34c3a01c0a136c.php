...
<div class="admin-shell" id="adminPanelShell">
    ...
    <aside class="sidebar">
        ...
        <a class="nav-link sub <?php echo e(request()->routeIs('admin.wallet-transfers.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.wallet-transfers.index')); ?>">↳ Wallet Transfers</a>
        ...
        <a class="nav-link sub <?php echo e(request()->routeIs('admin.gateway-transactions.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.gateway-transactions.index')); ?>">↳ Gateway Deposits</a>
        ...
        <a class="nav-link <?php echo e(request()->routeIs('admin.manual-deposits.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.manual-deposits.index')); ?>">
