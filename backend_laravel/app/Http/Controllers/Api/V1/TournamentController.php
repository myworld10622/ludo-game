...
class TournamentController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'bot_start_policy'      => ['sometimes', Rule::in(['disabled', 'fill_missing', 'replace_offline', 'hybrid'])],
            'min_real_players_to_start' => 'sometimes|integer|min:1|max:4',
            'bot_fill_after_seconds' => 'sometimes|integer|min:0|max:300',
    ...
    public function claimRoom(Request $request, Tournament $tournament): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data'    => [
                ...
                'bot_fill_after_seconds' => $tournament->resolveBotFillAfterSeconds(),
