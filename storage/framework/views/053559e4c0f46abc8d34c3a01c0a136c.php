...
<div class="admin-shell" id="adminPanelShell">
    ...
    <aside class="sidebar">
        ...
        <a class="nav-link <?php echo e(request()->routeIs('admin.games.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.games.index')); ?>">Games</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.games.ludo-tables.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.games.ludo-tables.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Classic Ludo Tables</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.tournaments.index') || request()->routeIs('admin.tournaments.create') ? 'active' : ''); ?>" href="<?php echo e(route('admin.tournaments.index')); ?>">Tournaments</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.tournaments.matches') ? 'active' : ''); ?>" href="<?php echo e(route('admin.tournaments.matches')); ?>" style="padding-left:24px;font-size:13px;">↳ Match Monitor</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.users.index')); ?>">Users</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.support.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.support.index')); ?>">Support Tickets</a>
        ...
        <a class="nav-link <?php echo e(request()->routeIs('admin.deposits.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.deposits.index')); ?>">Deposits</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.deposits.bonus.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.deposits.bonus.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Deposit Bonus</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.deposits.percentage.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.deposits.percentage.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Deposit Percentage</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.withdrawals.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.withdrawals.index')); ?>">Withdrawals</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.withdrawals.redeem.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.withdrawals.redeem.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Redeem Presets</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.gateways.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.gateways.manual.index')); ?>">Payment Gateways</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.gateways.manual.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.gateways.manual.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Manual Gateways</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.gateways.agent.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.gateways.agent.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Agent Gateways</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.gateways.agent-withdraw.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.gateways.agent-withdraw.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Agent Withdraw</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.gateways.distributor.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.gateways.distributor.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Distributor Gateways</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.gateways.distributor-withdraw.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.gateways.distributor-withdraw.index')); ?>" style="padding-left:24px;font-size:13px;">↳ Distributor Withdraw</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.settings.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.app')); ?>">Settings</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.settings.app') ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.app')); ?>" style="padding-left:24px;font-size:13px;">↳ App Configuration</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.agents.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.agents.index')); ?>">Agents</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.agents.create') ? 'active' : ''); ?>" href="<?php echo e(route('admin.agents.create')); ?>" style="padding-left:24px;font-size:13px;">↳ Add Agent</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.distributors.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.distributors.index')); ?>">Distributors</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.distributors.create') ? 'active' : ''); ?>" href="<?php echo e(route('admin.distributors.create')); ?>" style="padding-left:24px;font-size:13px;">↳ Add Distributor</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.legacy-reports.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.legacy-reports.index')); ?>">Legacy Reports</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.legacy-reports.purchase-history') ? 'active' : ''); ?>" href="<?php echo e(route('admin.legacy-reports.purchase-history')); ?>" style="padding-left:24px;font-size:13px;">↳ Purchase History</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.legacy-reports.deposit-bonus') ? 'active' : ''); ?>" href="<?php echo e(route('admin.legacy-reports.deposit-bonus')); ?>" style="padding-left:24px;font-size:13px;">↳ Deposit Bonus</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.legacy-reports.bet-commission') ? 'active' : ''); ?>" href="<?php echo e(route('admin.legacy-reports.bet-commission')); ?>" style="padding-left:24px;font-size:13px;">↳ Bet Commission</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.legacy-reports.rebate-history') ? 'active' : ''); ?>" href="<?php echo e(route('admin.legacy-reports.rebate-history')); ?>" style="padding-left:24px;font-size:13px;">↳ Rebate History</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.legacy-reports.welcome-bonus') ? 'active' : ''); ?>" href="<?php echo e(route('admin.legacy-reports.welcome-bonus')); ?>" style="padding-left:24px;font-size:13px;">↳ Welcome Bonus</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.legacy-reports.withdrawal-logs') ? 'active' : ''); ?>" href="<?php echo e(route('admin.legacy-reports.withdrawal-logs')); ?>" style="padding-left:24px;font-size:13px;">↳ Withdrawal Logs</a>
        <a class="nav-link <?php echo e(request()->routeIs('admin.legacy-reports.redeem-list') ? 'active' : ''); ?>" href="<?php echo e(route('admin.legacy-reports.redeem-list')); ?>" style="padding-left:24px;font-size:13px;">↳ Redeem List</a>
        ...
        <a class="nav-link <?php echo e(request()->routeIs('admin.homepage-cards.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.homepage-cards.index')); ?>">🏠 Homepage Cards</a>
    </aside>
    <main class="content">
        <div class="topbar">
