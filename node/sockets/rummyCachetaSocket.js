...
module.exports = function (rummy_cacheta_socket, request, timer, BASE_URL) {

    rummy_cacheta_socket.on('connection', (socket) => {
        console.log("New Connection Rummy Cacheta ", socket.id)
        ...
        socket.on('join-room', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    // console.log(userData.rummy_cacheta_table_id);
                    socket.join("room" + userData.rummy_cacheta_table_id);
                        console.log("join-room", "User "+user_id+" Room "+userData.rummy_cacheta_table_id+" Joined Successfully");
                        socket.emit('join-room', "User "+user_id+" Room "+userData.rummy_cacheta_table_id+" Joined Successfully");
                }
                else {
                    res['code'] = 201;
        ...
        socket.on('get-table', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/get_table',
                        'headers': {
                    ...
                    request(options, function (error, response) {
                        ...
                        if(body.table_data!==undefined){
                            var rummy_cacheta_table_id = body.table_data[0].table_id;
                            socket.join("room" + rummy_cacheta_table_id);
                            rummy_cacheta_socket.in("room" + rummy_cacheta_table_id).emit('trigger', "call_status");
                            var clients = rummy_cacheta_socket.adapter.rooms.get("room" + rummy_cacheta_table_id);
                            ...
                            // if(numClients>1){
                                ...
                                setTimeout(function () {
                                    var options = {
                                        'method': 'POST',
                                        'url': BASE_URL+'/api/rummyCacheta/start_game',
                                        'headers': {
                                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                                        },
                                    ...
                                    request(options, function (error, response) {
                                        ...
                                        if(body.game_id!==undefined){
                                            ...
                                            // rummy_cacheta_socket.in("room" + rummy_cacheta_table_id).emit('trigger', "" + body.game_id);

                                            var roomname = "room"+rummy_cacheta_table_id;
                                            rummy_cacheta_socket.in(roomname).emit('trigger', ""+body.game_id);
                                            ...
                                            timeoutArr[roomname] = new timer(function() { autochaal(rummy_cacheta_table_id) }, timeout_time)
                                        }else{
                                            // rummy_cacheta_socket.in("room" + rummy_cacheta_table_id).emit('trigger', "call_status");
                                        }
                                    });
        ...
        socket.on('get-private-table', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/get_private_table',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
                    ...
                    request(options, function (error, response) {
                        ...
                        rummy_cacheta_socket.in("room" + body.table_data[0].table_id).emit('trigger', "call_status");
                        var clients = rummy_cacheta_socket.adapter.rooms.get("room" + body.table_data[0].table_id);
                        const numClients = clients ? clients.size : 0;
        ...
        socket.on('join-table', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/join_table',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('join-table-with-code', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/join_table_with_code',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
                    ...
                    request(options, function (error, response) {
                        ...
                        var body = JSON.parse(response.body);
                        socket.join("room" + body.table_data[0].table_id);
                        rummy_cacheta_socket.in("room" + userData.rummy_cacheta_table_id).emit('trigger', "call_status");
                    });
                }
                else {
                    res['code'] = 201;
                ...
                if (user) {
                    ...
                    request(options, function (error, response) {
                        ...
                        if(body.game_id!==undefined){
                            ...
                            var roomname = "room" + userData.rummy_cacheta_table_id;
                            rummy_cacheta_socket.in(roomname).emit('trigger', "" + body.game_id);
                            ...
                            timeoutArr[roomname] = new timer(function() { autochaal(userData.rummy_cacheta_table_id) }, timeout_time);
                        }else{
                            // rummy_cacheta_socket.in("room" + userData.rummy_cacheta_table_id).emit('trigger', "call_status");
                        }
                    });
        ...
        socket.on('leave-table', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/leave_table',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
                    ...
                    request(options, function (error, response) {
                        ...
                        var body = JSON.parse(response.body);
                        rummy_cacheta_socket.in("room" + userData.rummy_cacheta_table_id).emit('trigger', "call_status");
                        socket.leave("room" + userData.rummy_cacheta_table_id);
                    });
                }
                else {
                    res['code'] = 201;
        ...
        socket.on('pack-game', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/pack_game',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('my-card', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/my_card',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
                    ...
                    request(options, function (error, response) {
                        ...
                        // rummy_cacheta_socket.in("room" + userData.rummy_cacheta_table_id).emit('trigger', "call_status");
                        console.log("trigger room - "+userData.rummy_cacheta_table_id+" socket.rooms -", socket.rooms);
                    });
                }
                else {
                    res['code'] = 201;
        ...
        socket.on('card-value', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/card_value',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('drop-card', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/drop_card',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
                    ...
                    request(options, function (error, response) {
                        ...
                        rummy_cacheta_socket.in(roomname).emit('trigger', "call_status");
                        ...
                        if(body.bot!==undefined && body.bot==1){
                            timeoutArr[roomname] = new timer(function() { autochaal(userData.rummy_cacheta_table_id) }, bot_timeout)
                        }
                        else{
                            timeoutArr[roomname] = new timer(function() { autochaal(userData.rummy_cacheta_table_id) }, timeout_time)
                        }
        ...
        socket.on('get-card', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/get_card',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('get-drop-card', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/get_drop_card',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('declare', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/declare',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('declare-back', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': BASE_URL+'/api/rummyCacheta/declare_back',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on("disconnect", (reason) => {
            console.log("User Disconnected Rummy Cacheta - " + socket.id + " reason - " + reason);
        });
    ...
    function autochaal(room_id){
        var options = {
            'method': 'GET',
            'url': BASE_URL+'/api/cron/rummy_cacheta_socket/'+room_id
        };
        request(options, function (error, response) {
            if (error) throw new Error(error);
            // console.log(response.body);
            console.log("auto-chaal - "+room_id,response.body);
            rummy_cacheta_socket.in("room"+room_id).emit('trigger', "call_status");
            var roomname = "room"+room_id;
            // if(timeoutArr.roomname!==undefined){
                timeoutArr[roomname].stop();
            // }
            var clients = rummy_cacheta_socket.adapter.rooms.get("room" + room_id);
            const numClients = clients ? clients.size : 0;
