...
module.exports = function (color_prediction_3min_socket, request, BASE_URL) {
    ...
    color_prediction_3min_socket.on('connection', (socket) => {
        if (!game_created) {
            ...
            var options = {
                'method': 'GET',
                'url': BASE_URL+'/api/cron/color_prediction_3_min_create_socket'
            };
    ...
    function timer_function() {
        ...
        if (timer <= 0) {
            ...
            var options = {
                'method': 'GET',
                'url': BASE_URL+'/api/cron/color_prediction_3_min_winner_socket'
            };
            request(options, function (error, response) {
                if (error) throw new Error(error);
                game_created = false;
                ...
                request(options, function (error, response) {
                    ...
                    color_prediction_3min_socket.emit('color_prediction_3min_status', response.body);
