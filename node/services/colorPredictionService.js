...
const ColorPrediction = db.ColorPrediction;
const ColorPredictionBet = db.ColorPredictionBet;
const ColorPredictionRoom = db.ColorPredictionRoom;
const ColorPredictionMap = db.ColorPredictionMap;
const Card = db.Card;
    ...
    async walletHistory(userId) {
        try {
            const bets = await ColorPredictionBet.findAll({
                attributes: [
                    '*',
                    'tbl_color_prediction.room_id'
                    // [db.Sequelize.col('tbl_color_prediction.room_id'), 'room_id']
                ],
                include: [{
                    ...
                    // where: {
                    //   id: db.Sequelize.col('tbl_color_prediction_bet.color_prediction_id')
                    // }
                }],
                where: {
                    user_id: userId
