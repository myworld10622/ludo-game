...
class JhandiMunda extends REST_Controller
{
    ...
    public function get_active_game_post()
    {
        ...
        if ($game_data) {
            ...
            $data['heart_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+100)+$HeartAmount;
            $data['spade_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+100)+$SpadeAmount;
            $data['diamond_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+100)+$DiamondAmount;
            $data['club_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+100)+$ClubAmount;
            $data['face_amount'] = rand($game_data[0]->random_amount, $ge_data[0]->random_amount+100)+$FaceAmount;
            $data['flag_amount'] = rand($game_data[0]->random_amount, $ge_data[0]->random_amount+100)+$FlagAmount;
            $this->JhandiMunda_model->updateRandomAmount($game_data[0]->id,$data['heart_amount']);
    ...
    public function place_bet_post()
    {
        ...
        if ($bet_id) {
            ...
            log_statement ( $this->data['user_id'], JM,-$this->data['amount'],$bet_id) ;
            $data['message'] = 'Success';
            $data['bet_id'] = $bet_id;
    ...
    public function cancel_bet_post()
    {
        ...
        if ($this->JhandiMunda_model->DeleteBet($this->data['user_id'], $this->data['game_id'])) {

            foreach ($bet as $key => $value) {
                $this->JhandiMunda_model->AddWallet($this->data['user_id'], $value->amount);
            
                log_statement($this->data['user_id'], JM, $value->amount, $value->id, 0);
            }
