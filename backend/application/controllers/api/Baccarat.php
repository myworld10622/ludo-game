...
class Baccarat extends REST_Controller
{
    ...
    public function get_active_game_socket_post()
    {
        ...
        if ($game_data) {
            ...
            $data['player_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+4000)+$Playermount;
            $data['banker_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+4000)+$BankerAmount;
            $data['tie_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+4000)+$TieAmount;
            $data['player_pair_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+4000)+$PlayerPairAmount;
            $data['banker_pair_amount'] = rand($game_data[0]->random_amount, $game_data[0]->random_amount+4000)+$BankerPairAmount;
            $this->Baccarat_model->updateRandomAmount($game_data[0]->id,$data['player_amount']);
    ...
    public function cancel_bet_post()
    {
        ...
        if ($this->Baccarat_model->DeleteBet($this->data['user_id'], $this->data['game_id'])) {

            foreach ($bet as $key => $value) {
                $this->Baccarat_model->AddWallet($this->data['user_id'], $value->amount);
            
                log_statement($this->data['user_id'], BT, $value->amount, $value->id, 0);
            }
