...
class RummyTableMaster extends MY_Controller
{
    ...
    {
        $RandomFlag = $this->RummyTableMaster_model->getRandomFlag('point_rummy_random');
        $data = [
            'title' => 'Rummy Point Table Master Management',
            'RandomFlag' => $RandomFlag->point_rummy_random,
    ...
    public function ChangeStatus()
    {
        ...
        $Change = $this->RummyTableMaster_model->ChangeStatus();
        if ($Change) {
            echo 'true';
        } else {
            echo 'false';
