...
class ColorPrediction1Min extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(['ColorPrediction1Min_model','Users_model','Setting_model']);
    }
    ...
    public function index()
    {
        ...
        $AllGames = $this->ColorPrediction1Min_model->AllGames($startDate, $endDate);
        ...
        $data = [
            'title' => 'Color Prediction 1 Min History',
            'AllGames' => $AllGames,
            'RandomFlag'=>$RandomFlag->color_prediction_1_min_random,
            'setting' => $setting->color_prediction_1min_min_bet
        ];
        ...
        public function set_withdraw_amount()
    {
        ...
        $data = $this->ColorPrediction1Min_model->set_withdraw_amount($amount);
...
public function Gethistory() 
{
        ...
        // Get data
        $data = $this->ColorPrediction1Min_model->Gethistory($postData);
