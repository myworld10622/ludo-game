...
class DragonTigerLocalLogic_model extends MY_Model
{
    ...
    {
        $Query = $this->db->query('SELECT COUNT(`id`) as online FROM `tbl_dragon_tiger_bet_local` WHERE `dragon_tiger_id` = (SELECT `id` FROM `tbl_dragon_tiger_local` WHERE `room_id`=' . $RoomId . ' ORDER BY `id` DESC LIMIT 1)');
    ...
    {
        // $this->db->select('id,main_card,status,added_date');
        $this->db->from('tbl_dragon_tiger_local');
        if (!empty($RoomId)) {
    ...
    {
        $this->db->insert('tbl_dragon_tiger_bet_local', $bet_data);
        return $this->db->insert_id();
    }

    public function DeleteBet($bet_id, $user_id, $game_id)
    {
        return $this->db->where('dragon_tiger_id', $game_id)->where('user_id', $user_id)->delete('tbl_dragon_tiger_bet_local');
    }
    ...
    public function Update($data, $game_id)
    {
        ...
        $this->db->update('tbl_dragon_tiger_local', $data);
    ...
    {
        // echo $bet;
        $this->db->from('tbl_dragon_tiger_bet_local');
    ...
    public function MakeWinner($user_id, $bet_id, $amount, $comission, $game_id)
    {
        ...
        $this->db->where('id', $bet_id);
        $this->db->update('tbl_dragon_tiger_bet_local');
        ...
        $this->db->where('id', $game_id);
        $this->db->update('tbl_dragon_tiger_local');
    ...
    {
        $data = ['user_id' => $user_id, 'added_date' => date('Y-m-d H:i:s')];
        $this->db->insert('tbl_dragon_tiger_local', $data);
        return $this->db->insert_id();
    }
    ...
    {
        $this->db->select('tbl_dragon_tiger_local.*');
        $this->db->from('tbl_dragon_tiger_local');
        // $this->db->where('isDeleted', false);
    ...
    {
        $this->db->select('tbl_dragon_tiger_local.*,(select count(id) from tbl_dragon_tiger_bet_local where tbl_dragon_tiger_local.id=tbl_dragon_tiger_bet_local.dragon_tiger_id) as total_users');
        $this->db->from('tbl_dragon_tiger_local');
        $this->db->order_by('id', 'DESC');
        $this->db->limit(10);
        $Query = $this->db->get();
    ...
    function Gethistory($postData = null)
    {
        ...
        $this->db->order_by('tbl_dragon_tiger_local.id', 'asc');
        ...
        if ($searchValue) {
            $this->db->group_start();
            $this->db->like('tbl_dragon_tiger_local.added_date', $searchValue, 'after');
            $this->db->like('tbl_dragon_tiger_local.total_users', $searchValue, 'after');
            //$this->db->like('tbl_dragon_tiger_local.user_id', $searchValue, 'after');
            $this->db->like('tbl_dragon_tiger_local.total_amount', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.admin_profit', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.winning_amount', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.user_amount', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.comission_amount', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.random', $searchValue, 'after');
        ...
        if ($searchValue) {
            ...
            $this->db->like('tbl_dragon_tiger_local.total_users', $searchValue, 'after');
            // $this->db->like('tbl_dragon_tiger_local.user_id', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.total_amount', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.admin_profit', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.winning_amount', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.user_amount', $searchValue, 'after');
            $this->db->or_like('tbl_dragon_tiger_local.comission_amount', $searchValue, 'after');
        ...
        if ($min != "" && $max != "") {
            $this->db->where('DATE(tbl_dragon_tiger_local.added_date) >=', $min);
            $this->db->where('DATE(tbl_dragon_tiger_local.added_date) <=', $max);
        }
