...
class SevenUp_model extends MY_Model
{
    ...
    function Gethistory($postData = null)
    {
        ...
        $this->db->order_by('tbl_seven_up.id', 'asc');
        $totalRecords = $this->db->get()->num_rows();

         if ($min != "" && $max != "") {
            $this->db->where('DATE(tbl_seven_up.added_date) >=', $min);
            $this->db->where('DATE(tbl_seven_up.added_date) <=', $max);
        }
        ...
        if ($searchValue) {
            $this->db->group_start();
            $this->db->like('tbl_seven_up.added_date', $searchValue, 'after');
            $this->db->like('tbl_seven_up.total_users', $searchValue, 'after');
            // $this->db->like('tbl_seven_up.id', $searchValue, 'after');
            $this->db->like('tbl_seven_up.total_amount', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.admin_profit', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.winning_amount', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.user_amount', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.comission_amount', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.random', $searchValue, 'after');
        ...
        if ($searchValue) {
            ...
            $this->db->like('tbl_seven_up.total_users', $searchValue, 'after');
            // $this->db->like('tbl_seven_up.id', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.total_amount', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.admin_profit', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.winning_amount', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.user_amount', $searchValue, 'after');
            $this->db->or_like('tbl_seven_up.comission_amount', $searchValue, 'after');
        ...
        foreach ($records as $record) {
           ...
           $data[] = array(
    "id" => $i,
    "total_users" => '<a href="' . base_url('backend/SevenUp/seven_up_bet/' . $record->id) . '">' . $record->total_users . '</a>',
    // "user_id"=>$record->id,
    ...
    {
        $this->db->set('seven_up_min_bet', $amount);
        $this->db->where('id', 1);
        $this->db->update('tbl_setting');
    }
}