<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <?php
            echo form_open_multipart('backend/Distributor/update_agent', ['autocomplete' => false, 'id' => 'edit_agent'
            ...
            ?>
                ...
                <div class="form-group mb-0">
                    <div>
                        ...
                        ?>
                        <a href="<?= base_url('backend/Distributor') ?>" class="btn btn-secondary waves-effect">Cancel</a>
                    </div>
                </div>
                <?php
            echo form_close();
