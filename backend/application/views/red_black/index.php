                ...
                <table class="table table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><u><a href="<?= base_url('backend/RedBlack/RedBlackBet/' . $Games->id) ?>">
...
$(document).on('change', '#random', function(e) {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '<?= base_url('backend/RedBlack/ChangeStatus') ?>',
        data: {
            type: type
        },
        beforeSend: function() {},
...
$(document).ready(function() {
    ...
    dataTable = $(".table").DataTable({
        ...
        serverMethod: 'post',
        ajax: {
            "url": "<?= base_url('backend/RedBlack/Gethistory') ?>",
            "type": "POST",
            "datatype": "json",
            data: function(d) {
                d.min = $('#sn_date').val();
...
<script>
var baseUrl = "<?= base_url('backend/RedBlack/set_withdraw_amount') ?>";
