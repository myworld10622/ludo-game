                ...
                <table class="table table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><u><a href="<?= base_url('backend/CarRoulette/car_roulette_bet/' . $Games->id) ?>">
...
$(document).on('change', '#random', function(e) {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '<?= base_url('backend/CarRoulette/ChangeStatus') ?>',
        data: {
            type: type
        },
        beforeSend: function() {},
...
$(document).ready(function() {
    ...
    dataTable = $(".table").DataTable({
        ...
        serverMethod: 'post',
        ajax: {
            "url": "<?= base_url('backend/CarRoulette/Gethistory') ?>",
            "type": "POST",
            "datatype": "json",
            data: function(d) {
                d.min = $('#sn_date').val();
...
<script>
var baseUrl = "<?= base_url('backend/CarRoulette/set_withdraw_amount') ?>";
