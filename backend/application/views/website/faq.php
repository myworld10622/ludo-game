<div class="container-main">
    ...
    <div class="container" style="width: auto">
        ...
        <div class="right_box">
            <div class="box">
                <div class="title"><b>I can't install <?= PROJECT_NAME ?> App</b></div>
                <p>Make sure "Unknown Sources" is enabled at Settings > Security.<br>
                    Download the <?= PROJECT_NAME ?> app again from our official website.<br>
                    Click on the apk file on your notifications area or download folder.</p>
                <div class="title"><b>I can't update <?= PROJECT_NAME ?></b></div>
                <p>If for any reason, you're unable to update to the latest version of <?= PROJECT_NAME ?>, please
                    uninstall the version you have and then download and install the app again.</p>
                <div class="title"><b>How to play <?= PROJECT_NAME ?></b></div>
                <p><?= PROJECT_NAME ?> is typically played by 3 to 6 players uses 52-card pack without jokers. Like
                    other poker and rummy games, <?= PROJECT_NAME ?> starts by putting down a wager. For the most part,
                    ...
                    In any case, one should take note of that that wagering on <?= PROJECT_NAME ?> isn't equivalent to
                    poker. In <?= PROJECT_NAME ?>, you are required to have all the wagers in equivalent sums, implying
                ...
                <div class="title"><b>What's the <?= PROJECT_NAME ?> Rules</b></div>
