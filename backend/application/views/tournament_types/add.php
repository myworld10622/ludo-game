<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <?php
                echo form_open_multipart('backend/TournamentTypes/insert', [
                    'autocomplete' => false,
                    'id' => 'add_tournament_types',
                    'method' => 'post'
                ...
                <div class="form-group row"><label for="image" class="col-sm-2 col-form-label">Image</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="file" name="image" required id="image" required>
                    </div>
                </div>
