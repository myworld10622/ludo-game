            ...
            <div class="row">
                ...
                <div class="col-2">
                    <div class="form-group">
                        ...
                        <input type="number" id="amount" name="amount" class="form-control" onkeyup="submitAmount()" value="<?= isset($setting) ? $setting : '' ?>" required>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    var baseUrl = "<?= base_url('backend/AnderBaharPlus/set_withdraw_amount') ?>";
