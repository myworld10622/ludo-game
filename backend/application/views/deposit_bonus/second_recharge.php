            ...
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php
                        $i = 0;
                        foreach ($second_recharge as $key => $recharge) {
                            $i++;
                        ?>
                            <tr>
                                <td><?= $i ?></td>
                                ...
                                <td>
                                   <a href="<?= base_url('backend/Recharge/edit_second_recharge/' . $recharge->id) ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><span class="fa fa-edit"></span></a>
