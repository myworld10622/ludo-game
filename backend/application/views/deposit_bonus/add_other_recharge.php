<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
            <?php
            echo form_open_multipart('backend/Recharge/insert_other_recharge', ['autocomplete' => false, 'id' => 'add_chips'
            ...
            ?>
                ...
                <div class="form-group row"><label for="bonus" class="col-sm-2 col-form-label">Bonus Amount *</label>
                    <div class="col-sm-10">
