    ...
    <div class="col-12">
        <div class="card">
            ...
            ?>
                ...
                <div class="form-group row"><label for="game_count" class="col-sm-2 col-form-label">Game Count
                        *</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="number" min="0" step="1" name="game_count"  id="game_count">
                    </div>
                </div>
