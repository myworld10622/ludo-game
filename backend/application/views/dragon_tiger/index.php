                ...
                <div class="row">
                    ...
                    <div class="col-md-6 lp-0">
                        <select class="form-control w-100" name="random" id="random">
                            ...
                            <option value="3" <?= ($RandomFlag == 3) ? 'selected' : '' ?>>Dragon</option>
                            <option value="4" <?= ($RandomFlag == 4) ? 'selected' : '' ?>>Tiger</option>
                        </select>
                    </div>
                </div>
                <br>
...
$(document).on('change', '#random', function(e) {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '<?= base_url('backend/DragonTiger/ChangeStatus') ?>',
        data: {
            type: type
        },
        beforeSend: function() {},
...
$(document).ready(function() {
    ...
    dataTable = $(".table").DataTable({
        ...
        serverMethod: 'post',
        ajax: {
            "url": "<?= base_url('backend/DragonTiger/Gethistory') ?>",
            "type": "POST",
            "datatype": "json",
            data: function(d) {
                d.min = $('#sn_date').val();
...
<script>
var baseUrl = "<?= base_url('backend/DragonTiger/set_withdraw_amount') ?>";
