...
$(document).on('change', '#random', function(e) {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '<?= base_url('backend/ColorPrediction5Min/ChangeStatus') ?>',
        data: {
            type: type
        },
        beforeSend: function() {},
...
$(document).ready(function() {
    ...
    dataTable = $(".table").DataTable({
        ...
        serverMethod: 'post',
        ajax: {
            "url": "<?= base_url('backend/ColorPrediction5Min/Gethistory') ?>",
            "type": "POST",
            "datatype": "json",
            "data": function(d) {
...
<script>
var baseUrl = "<?= base_url('backend/ColorPrediction5Min/set_withdraw_amount') ?>";
