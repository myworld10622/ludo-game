                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if ($_ENV['ENVIRONMENT'] != 'demo') { ?>
                            <td>
                                <a href="<?= base_url('backend/table/game/' . $Table->table_id) ?>"
                                    class="btn btn-primary" data-toggle="tooltip" data-placement="top"
                                    title="View Game">
                                    <span class="fa fa-eye"></span>
                                </a>
                                |
                                <a href="<?= base_url('backend/table/ActiveGame/' . $Table->table_id) ?>"
                                    class="btn btn-primary" data-toggle="tooltip" data-placement="top"
                                    title="View Active Game">
                                    <span class="fa fa-eye"></span>
                                </a>
                                |
                                <a href="<?= base_url('backend/table/delete/' . $Table->table_id) ?>"
